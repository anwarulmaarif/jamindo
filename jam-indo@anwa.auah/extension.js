...
export default class JamIndo extends Extension {
    ...
    //        false
    //    );
    //    let schemaObj = schemaSource.lookup('org.gnome.shell.extensions.jam-indo', true);
    //    return new Gio.Settings({ settings_schema: schemaObj });
    return this.getSettings('org.gnome.shell.extensions.jam-indo');
    }
    ...
    enable() {
        ...
        const override = () => {
            ...
            let clockFormat = this.clockFormatOverride;

            if (clockFormat === 'default') {
                clockFormat = gnomeSettings.get_string("clock-format");
            } else {
                // Override sistem
                gnomeSettings.set_string("clock-format", clockFormat);
            }
        ...
        this.clockFormatOverride = this.settings.get_string('clock-format');
